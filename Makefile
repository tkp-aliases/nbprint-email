...
lint-py:  ## lint python with ruff
	python -m ruff check nbprint_email
	python -m ruff format --check nbprint_email
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix nbprint_email
	python -m ruff format nbprint_email
...
test:  ## run python tests
	python -m pytest -v nbprint_email/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v nbprint_email/tests --cov=nbprint_email --cov-report term-missing --cov-report xml
